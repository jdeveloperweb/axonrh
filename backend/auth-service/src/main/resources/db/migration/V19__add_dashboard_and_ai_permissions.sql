...
('DASHBOARD', 'READ', 'Visualizar Dashboard', 'Permite acessar o dashboard e ver a visão do colaborador', 'dashboard'),
('DASHBOARD', 'MANAGEMENT_READ', 'Métricas de Gestão', 'Permite acessar a visão detalhada com métricas da organização', 'dashboard'),
