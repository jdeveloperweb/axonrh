...
export default function NewEmployeePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Erro',
        description: error.response?.data?.message || 'Falha ao cadastrar colaborador',
        variant: 'destructive',
      });
    } finally {
      setLoading(false);
  ...
  const tabs = [
    { key: 'personal' as TabKey, label: 'Dados Pessoais', icon: User },
    { key: 'address' as TabKey, label: 'Endereço', icon: MapPin },
    { key: 'professional' as TabKey, label: 'Dados Profissionais', icon: Briefcase },
      ...
      <form onSubmit={handleSubmit}>
        ...
        {activeTab === 'documents' && (
          <Card>
            ...
            <CardContent>
              <p className="text-[var(--color-text-secondary)]">
                Os documentos podem ser adicionados após o cadastro do colaborador.
              </p>
            </CardContent>
          </Card>
        )}
        ...
        {activeTab === 'dependents' && (
          <Card>
            ...
            <CardContent>
              <p className="text-[var(--color-text-secondary)]">
                Os dependentes podem ser adicionados após o cadastro do colaborador.
              </p>
            </CardContent>
          </Card>
        )}
