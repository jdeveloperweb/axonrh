                                    ...
                                    <div className="grid md:grid-cols-2 gap-8">
                                        <div className="space-y-4">
                                            ...
                                            <Input
                                                ...
                                                onChange={e => setCourseCertificateConfig({ ...courseCertificateConfig!, instructorName: e.target.value })}
                                            />
                                        </div>
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex gap-2">
                                                <Input
                                                    ...
                                                    onChange={e => setCourseCertificateConfig({ ...courseCertificateConfig!, instructorSignatureUrl: e.target.value })}
                                                />
                                            </div>
                                        </div>
                                    </div>
