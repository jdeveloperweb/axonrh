        ...
        <div className="min-h-screen bg-slate-50/50">
            <div className="p-8 max-w-7xl mx-auto space-y-8">
                ...
                <Tabs defaultValue="manager" className="space-y-6">
                    ...
                    <TabsContent value="manager" className="space-y-6 animate-in fade-in-50 duration-300">
                        {/* Stats Cards */}
                    ...
                    <TabsContent value="employee" className="space-y-6 animate-in fade-in-50 duration-300">
